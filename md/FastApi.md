...
![fastapi-tutorial](https://cdn.jsdelivr.net/gh/aron0524/picgo@main/doc/202301181153049.png)
...
1. 简易版前端效果
   ...
   ![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview01.png)

2. API交互文档 - **Swagger UI** [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview02.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview02.png)

3. 第三章的接口 [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview03.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview03.png)

4. 第四、五章的接口 [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview04.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview04.png)

5. 接口的参数、返回的状态码、描述 [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview05.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview05.png)

6. 接口认证的效果 [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview06.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview06.png)

7. 第七、八章和`Coronavirus`应用的接口 [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview07.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview07.png)

8. 城市信息表 [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview08.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview08.png)

9. 感染数据表 [![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/preview09.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/preview09.png)
...
[![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/chapter02.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/chapter02.png)
...
[![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/chapter03.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/chapter03.png)
...
[![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/chapter04.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/chapter04.png)
...
[![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/chapter05.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/chapter05.png)
...
[![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/chapter06.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/chapter06.png)
...
[![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/chapter07.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/chapter07.png)
...
[![drf-tutorial](https://cdn.jsdelivr.net/gh/liaogx/fastapi-tutorial@master/coronavirus/static/chapter08.png)](https://github.com/liaogx/fastapi-tutorial/blob/master/coronavirus/static/chapter08.png)
